    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 32)) {
            throw new \InvalidArgumentException('invalid length for $username when calling CreateUserRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($username) < 3)) {
            throw new \InvalidArgumentException('invalid length for $username when calling CreateUserRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $password when calling CreateUserRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling CreateUserRequest., must be bigger than or equal to 8.');
        }
