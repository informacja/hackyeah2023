...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling Pagination., must be smaller than or equal to 100.');
        }
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling Pagination., must be bigger than or equal to 1.');
        }
